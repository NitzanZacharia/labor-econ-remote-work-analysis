...
The $Mother_i \times GilNK_i$ term (an interaction with the categorical age-group control) is included because pre-period covariate balance tests (Section~4) reveal an age imbalance between mothers and non-mothers whose \emph{magnitude} itself varies systematically with WFH-exposure quartile -- a pattern an additive age control cannot absorb.
